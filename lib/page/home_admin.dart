      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Color.fromARGB(255, 255, 255, 255), Color.fromARGB(255, 150, 140, 152)], // พื้นหลังแบบไล่สี
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      text: TextSpan(
                        ...
                        style: TextStyle(
                          ...
                          shadows: [
                            Shadow(
                              blurRadius: 5.0,
                              color: const Color.fromARGB(187, 91, 84, 84),
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: const Color.fromARGB(255, 32, 130, 17),
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromARGB(255, 102, 15, 119),
                        padding: EdgeInsets.symmetric(
                            vertical: 15, horizontal: 30),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(12),
