        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Container(
              ...
              padding: EdgeInsets.all(16.0),
              width: 350, // กำหนดความกว้างของกล่องสี่เหลี่ยม
              decoration: BoxDecoration(
                color: const Color.fromARGB(255, 211, 113, 247), // สีพื้นหลังของกล่องสี่เหลี่ยม
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromARGB(255, 220, 223, 220), // เปลี่ยนสีพื้นหลังของปุ่ม
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: 20,
                            color: const Color.fromARGB(255, 15, 15, 15)), // เปลี่ยนสีข้อความและขนาด
                      ),
                    ),
                    TextButton(
                      onPressed: () {
