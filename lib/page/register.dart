                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              ...
                              colors: [
                                Color.fromARGB(255, 147, 147, 241),
                                Color.fromARGB(255, 155, 23, 203),
                              ],
                            ),
                          ),
                          child: Text(
                            'register',
                            style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900, color: const Color.fromARGB(255, 255, 255, 255)),
                          ),
                        ),
                      ),
